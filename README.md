...
| Commute traffic | Google Maps API key | Google Cloud Console |
| Weather | OpenWeather API key | [openweathermap.org](https://openweathermap.org/api) |

Leave them blank to run in demo/manual mode — everything still works, just with placeholder data where a live feed would go.
